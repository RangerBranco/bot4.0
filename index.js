...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Kratos\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=558694292223:+55 86 94292223\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '*'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO KRATOS*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Kratos? Este é um recurso especial para o KRATOS❌',
					ownerB: '[❗] Kratos? Este é um recurso especial para o KRATOS❌',
			...
			const ownerNumber = ["558694292223@s.whatsapp.net","558981246187@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"558694292223@s.whatsapp.net","558981246187@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["558694292223@s.whatsapp.net","558981246187@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["558694292223@s.whatsapp.net","558981246187@s.whatsapp.net"]//ubah nomor lo
			const premium = ["558694292223@s.whatsapp.net","558981246187@s.whatsapp.net"]
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("Alguem ai pra jogar?")){
			...
			switch(command) {
				...
				case 'help':
				case 'menu':
					buff = await getBuffer('https://i.ibb.co/y576xf4/Whats-App-Image-2021-03-16-at-13-45-53.jpg')
